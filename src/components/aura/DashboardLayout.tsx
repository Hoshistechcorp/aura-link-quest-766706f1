...
const navSections: NavSection[] = [
  ...
  {
    title: "Microsite Modules",
    defaultOpen: true,
    items: [
      { icon: Landmark, label: "Attractions", path: "/dashboard/modules/attractions" },
      { icon: CalendarDays, label: "Events & Festivals", path: "/dashboard/modules/events" },
      { icon: UtensilsCrossed, label: "Dining", path: "/dashboard/modules/cuisine" },
      { icon: Hotel, label: "Hotels & Stays", path: "/dashboard/modules/hotels" },
      { icon: Compass, label: "Plan Your Trip", path: "/dashboard/modules/planTrip" },
      { icon: Train, label: "Getting Around", path: "/dashboard/modules/transportation" },
    ],
  },
  {
    title: "Experiences",
    defaultOpen: false,
    items: [
      { icon: Palette, label: "Cultural Experiences", path: "/dashboard/modules/culture" },
      { icon: Wine, label: "Nightlife", path: "/dashboard/modules/nightlife" },
      { icon: Trophy, label: "Sports", path: "/dashboard/modules/sports" },
      { icon: TreePine, label: "Nature & Eco", path: "/dashboard/modules/nature" },
      { icon: Baby, label: "Family", path: "/dashboard/modules/family" },
      { icon: Camera, label: "Photo & Video", path: "/dashboard/modules/photos" },
    ],
  },
  {
    title: "Engagement",
  ...
  },
  {
    ...
    defaultOpen: false,
    items: [
      { icon: Landmark, label: "Sponsored Attractions", path: "/dashboard/sponsored-attractions" },
      { icon: CalendarDays, label: "Event Promotion", path: "/dashboard/event-promotion" },
      { icon: Store, label: "Business Promotion", path: "/dashboard/business-promotion" },
    ],
  },
  {
    title: "Business",
...
const locations = [
  { id: "atlanta-downtown", label: "Meridian Tours — Downtown Atlanta" },
  { id: "atlanta-midtown", label: "Meridian Tours — Midtown" },
  { id: "atlanta-buckhead", label: "Meridian Tours — Buckhead" },
];

const DashboardLayout = ({ children, title, subtitle = "Meridian Tours · Tour Operator" }: DashboardLayoutProps) => {
